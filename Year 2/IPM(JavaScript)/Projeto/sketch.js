...
function draw()
{
  ...
  {     
    ...
    for(var j = 0; j <= 12; j++) {letters[j].drawLetter();}
...
function windowResized() 
{
  if (fullscreen())
  {
    ...
    //createTargets_old(legendas, targetSize * PPCM, horizontal_gap * PPCM - 80, vertical_gap * PPCM - 80);
    createTargets(legendas, PPCM, windowWidth, windowHeight);
